...
if __name__ == "__main__":
    ...
    ROOT_DIR = "/local/bys2107/research/data/OLMoE-acts/"
    print("Available paths:", os.listdir(ROOT_DIR))
    gsm8k_train = extractor.load_activations(ROOT_DIR + "gsm8k/gsm8k_train_questions_50samples.pt")
    sciq_train = extractor.load_activations(ROOT_DIR + "sciq/sciq_train_questions_50samples.pt")
    sciq_test = extractor.load_activations(ROOT_DIR + "sciq/sciq_train_questions_50samples.pt")
    # Save directory
    # save_dir = "/local/bys2107/research/data/figs"
